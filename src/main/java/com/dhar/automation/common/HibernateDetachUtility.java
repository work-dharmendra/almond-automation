...
public class HibernateDetachUtility {
     ...
     */
    private static final String PACKAGE_PREFIX = "com.dhar.automation.domain";
    ...
    public static void deProxy(Object value){
        try {
            nullOutUninitializedFields(value, SerializationType.SERIALIZATION);
        } catch (Exception e) {
    ...
    private static void nullOutFieldsByFieldAccess(Object object, List<Field> classFields,
        ...
        for (Field field : classFields) {
            ...
            if (fieldValue instanceof HibernateProxy) {
                ...
                if (fieldValue instanceof org.hibernate.collection.internal.AbstractPersistentCollection) {
                    // Replace hibernate specific collection types

                    if (!((org.hibernate.collection.internal.AbstractPersistentCollection) fieldValue).wasInitialized()) {
                        Object replacement = null;
